  ...
  <a-row justify="center">
    ...
    <a-col :span="12">
      ...
      <a-form
        ...
        <a-space
          v-for="(gift, index) in config.gift_list" :key="gift.id" align="baseline">
          ...
          <a-select ref="select" v-model:value="gift.op"
                    :options="operateOptions"
          ></a-select>

          <a-form-item :name="['users', index, 'op_value']">
            <a-input v-model:value="gift.op_value" placeholder="变化量(时间加减为秒，乘除为倍数，清零忽略)"/>
          </a-form-item>
